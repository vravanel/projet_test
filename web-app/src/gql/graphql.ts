...
export type GetReponsesByQuestionIdQuery = { __typename?: 'Query', getReponsesByQuestionId: Array<{ __typename?: 'Reponse', id: string, title: string, isValid?: boolean | null }> };
